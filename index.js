...
let db = {
    users: [
        {
            id: 1, name: 'John Doe', phone: '235235', address: '123 Main St', age: 25, image_url: 'https://example.com/image1.jpg',
        },
...
const add_item = () => {
    ...
    const add_button = document.getElementById('add-new');
